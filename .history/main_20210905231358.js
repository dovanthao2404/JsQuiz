...
// Bài 10:
// var result = undefined ?? "HowKteam";
// console.log(result) // HowKteam
// Bài 11:
...
Array.prototype.reduce2 = (callback, result) => {
  ...
  for (; i < this.length; i++) {
    resultGet = callback(result, this[i], i, this)
  }
  return total;
...
var a = [10, 20, 50, 30];
let total1 = a.reduce((total, value, key) => { return total + value }, 0)

// let total = a.reduce2((total, value, key) => { return total + value }, 0)
console.log(total1)
